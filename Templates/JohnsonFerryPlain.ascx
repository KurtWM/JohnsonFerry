<%@ Control Language="c#" Inherits="ArenaWeb.Templates.JohnsonFerryPlain" CodeFile="~/Custom/JohnsonFerry/Templates/JohnsonFerryPlain.ascx.cs" %>
...
<div class="container_16 pageContent">
    ...
    <div class="container_16 pageHeader">
	    <div class="grid_16 topNavBar testclass">
		    <asp:PlaceHolder ID="NavPH" Runat="server"></asp:PlaceHolder>
	    </div>
    </div>
