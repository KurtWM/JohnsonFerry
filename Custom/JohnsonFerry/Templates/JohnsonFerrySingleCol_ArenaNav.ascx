<%@ Control Language="c#" Inherits="ArenaWeb.Templates.JohnsonFerrySingleCol_ArenaNav" CodeFile="~/Custom/JohnsonFerry/Templates/JohnsonFerrySingleCol_ArenaNav.ascx.cs" %>
...
<div class="container_16 pageContent">
    ...
    <div class="container_16 MainContentArea">
        ...
        <div id="ContentPaneDiv" class="grid_16 ContentPane" runat="server">
