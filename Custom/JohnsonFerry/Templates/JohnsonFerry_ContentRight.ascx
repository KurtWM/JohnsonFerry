<%@ Control Language="c#" Inherits="ArenaWeb.Templates.JohnsonFerry_ContentRight" CodeFile="~/Custom/JohnsonFerry/Templates/JohnsonFerry_ContentRight.ascx.cs" %>

<div class="container_16 pageContent">
        <div id="JFLogo" class="grid_4">
            <a href="http://jfaccess.johnsonferry.org"><img src="/Custom/JohnsonFerry/Images/Johnson-Ferry-logo-top.png" alt="Johnson Ferry Logo" height="110" width="220" /></a></div>
    ...
    <div class="container_16 MainContentArea">
        <div class="grid_16">&nbsp;</div>
        <div class="grid_5">
            <div><!--[ADDTHIS]--></div>
            <div id="SidePaneDiv" class="SidePane" runat="server">
                <asp:PlaceHolder ID="SidePH" Runat="server"></asp:PlaceHolder>&nbsp;</div>
        </div>
        <div class="grid_11">
